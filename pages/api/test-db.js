...
export default async function handler(req, res) {
  ...
  try {
    ...
    const dbUrl = process.env.DATABASE_URL || 'postgresql://postgres.delbmpkkbaxchritxjjx:SLOTH223SLOTH@aws-1-eu-north-1.pooler.supabase.com:6543/postgres?pgbouncer=true';
